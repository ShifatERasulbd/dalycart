    ...
    <div class="row repeater-item mb-4">
        <div class="col-md-3">
            <div class="form-group mb-2">
                <select class="form-control" name="variations[0][color]">
        ...
        <div class="col-md-3">
            <div class="form-group mb-2">
                <select class="form-control" name="variations[0][size]">
        ...
        <div class="col-md-3">
            <input type="number" name="variations[0][price]" class="form-control mb-2" placeholder="Price" required>

            <input type="file" name="variations[0][image]" class="form-control image-input" accept="image/*" onchange="previewImage(this)">
...
<div class="col-sm-12 mb-3">
  <div class="form-group">
    <label for="description" class="form-label">Description *</label>
    <textarea id="description" name="description" rows="6" class="summernote form-control @error('description') is-invalid @enderror" required></textarea>
    @error('description')
    <span class="invalid-feedback" role="alert">
      <strong>{{ $message }}</strong>
    </span>
...
<div class="col-sm-12 mb-3">
  <div class="form-group">
    ...
    <textarea id="description_bn" name="description_bn" rows="6" class="form-control"></textarea>
  </div>
</div>
