...
class DashboardController extends Controller
{
    ...
    public function dashboard(){
        ...
        $completed_order = Order::where('order_status',6)->count();
        $order_in_qourier = Order::where('order_status',5)->count();
        $cancelled_order = Order::where('order_status',7)->count();
        ...
        return view('backEnd.admin.dashboard',compact('total_order','completed_order','pending_order','cancelled_order','order_in_qourier','today_order','total_product','total_customer','latest_order','latest_customer','today_delivery','total_delivery','last_week','last_month','monthly_sale'));
    }
