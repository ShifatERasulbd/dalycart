...
class FrontendController extends Controller
{
    ...
    {
        // return "Welcome to AhsanBazar.com";
    ...
    public function details($slug)
    {
        ...
        return view('frontEnd.layouts.pages.details', compact('details', 'products','product_id', 'shippingcharge', 'productcolors', 'productsizes', 'reviews'));
    }
